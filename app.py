...
departments = ["Production", "Maintenance", "Quality", "Stores"]
categories = ["Hardware", "Software", "Network"]
sub_categories = ["Printer", "PC", "Switch", "ERP"]
statuses = ["Open", "In Progress", "Closed"]

# --- IT Staff View: Ticket Creation ---
if user_type == "IT Staff":
    st.subheader("📝 Generate IT Task Request")
    with st.form("task_form"):
        plant = st.selectbox("Plant", plants)
        raised_by = st.selectbox("Raised By", staff_names)
