...
plants = ["Plant A", "Plant B", "Plant C", "Other"]
departments = ["Production", "Maintenance", "Quality", "Stores", "Other"]
categories = ["Hardware", "Software", "Network", "Other"]
sub_categories = ["Printer", "PC", "Switch", "ERP", "Other"]
    ...
    if df.empty:
        ...
        with st.form("assign_form"):
            ...
            if st.form_submit_button("Assign Task"):
                ...
                st.success(f"✅ Task ID {task_to_assign} assigned to {assign_person}. Notification logged.")
